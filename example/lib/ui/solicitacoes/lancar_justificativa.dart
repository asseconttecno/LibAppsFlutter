                        ...
                        child: Padding(
                          ...
                          child: PopupMenuButton<int>(
                            ...
                            onSelected: (value) async {
                              Uint8List? _f;
                              if(value == 1){
                                _f = (await CameraService.getImage()) ;
                              }else{
                                _f = (await CameraService.getGallery()) ;
                              }
                    ...
                    children: [
                      Container(
                        child: TextButton(
                          child:   Padding(
                            ...
                            child: CustomText.text("Cancelar", style: TextStyle(fontSize: 14),),
                          ),
                          onPressed: (){
                      ...
                      Container(
                        child: TextButton(
                          child:   Padding(
                            padding: EdgeInsets.only(top: 12,),
                            child: CustomText.text("Ok",style: TextStyle(fontSize: 14),),
                          ),
                          onPressed: () async {
