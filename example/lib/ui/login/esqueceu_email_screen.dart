...
class EsqueceuEmailScreen extends StatefulWidget {
  ...
  EsqueceuEmailScreen(this.scaffoldKey);

  @override
  State<EsqueceuEmailScreen> createState() => _RecadastroScreenState();
}

class _RecadastroScreenState extends State<EsqueceuEmailScreen> {
  ...
  Container _menssagem( ) {
    return Container(
      ...
      child: Text("Informe o cnpj da sua empresa, seu numero de registro e CPF",
