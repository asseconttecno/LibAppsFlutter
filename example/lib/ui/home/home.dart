...
class _HomePageState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: SafeArea(
        child: Consumer<UserPontoManager>(
              builder: (_, user,__){
                          ...
                          Expanded(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder:   (BuildContext context, int index) {
                                customIcon(user.homeModel?.resultadoItemList![index].descricao ?? '');
                                return CustomListTile(
                                    icon,
                                    user.homeModel?.resultadoItemList![index].descricao ?? '',
                                    user.homeModel?.resultadoItemList![index].valor ?? '',
                              ...
                              itemCount: (user.homeModel?.resultadoItemList?.length ?? 0),
                            ),
                          ),
                        ],
                    )
