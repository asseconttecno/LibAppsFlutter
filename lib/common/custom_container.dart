...
Widget CustomContainer({required Widget child, required Color color, bool center = true, double margin = 8,
  ...
  return Container(
    ...
    decoration: BoxDecoration(
        ...
        border: isBorder ? Border.all(color: borderColor ?? color) : null
    ),
