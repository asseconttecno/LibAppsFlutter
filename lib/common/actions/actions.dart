  ...
  return Padding(
    ...
    child: PopupMenuButton<int>(
      ...
      itemBuilder: (context) => [
        ...
        ] else if(Config.conf.nomeApp == VersaoApp.AssewebApp && aponta) ...[
          PopupMenuItem(
            key: key1,
            value: 0,
            child: CustomText.text("Alterar Empresa"),
          ),
        ] else if(Config.conf.nomeApp == VersaoApp.PontoApp && aponta ) ...[
          PopupMenuItem(
            key: key1,
            value: 1,
      ...
      onSelected: (value) async {
        switch( value ){
          ...
          case 5 :
            ...
            break;
          case 6 :
            RegistroManger().enviarMarcacoesHistorico(context, UserPontoManager.susuario);
            break;
        }
      },
